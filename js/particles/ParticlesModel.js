...
ParticlesModel.prototype = {
  init: function() {
    ...
    this._gui
      .add(this.data, "initialAttraction", 0, 0.3)
      .step(0.0001)
      .onChange(callback);
    this._gui
      .add(this.data, "frictions", 0, 0.5)
      .step(0.001)
      .onChange(callback);
    this._gui
      .add(this.data, "velocityMax", 0, 0.02)
      .step(0.00001)
      .onChange(callback);
    ...
    this._gui
      .add(this.data, "mapStrength", 0, 0.2)
      .step(0.0001)
      .onChange(callback);

    this._gui.add(this.data, "resetStacked").onChange(callback);
    this._gui
      .add(this.data, "stackSensibility", 0, 3)
      .step(0.00001)
      .onChange(callback);
